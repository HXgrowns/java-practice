...
class StreamingTest {
    ...
    void should_be_able_to_generate_infinite_stream_of_sequence() {
        // TODO: please modify the following code to pass the test
        // <--start
        try (Stream<Integer> infiniteSequence = Stream.generate(() -> 10000))
        // --end-->
        {
    ...
    void should_be_able_to_filter_stream() {
        ...
        // <--start
        try (Stream<String> filtered = wordStream.filter(string -> string.length() > 4))
        // --end-->
        {
    ...
    void should_flatten_stream_of_streams() {
        ...
        // TODO: please modify the following code to pass the test
        // <--start
        try (Stream<Character> flatted = nameStream.flatMap(t -> t))
        // --end-->
        {
            assertArrayEquals(
                    new Character[]{
